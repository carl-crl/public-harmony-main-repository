 ...
 <div class="w3-container" style="margin-top: 32px">
    <!-- Multi-Tab Navigation for User Management -->
        <div class="w3-bar w3-light-grey">      
            ...
            <button class="w3-bar-item w3-button tablink" onclick="openTab(event, 'um_help_id')">
              <h5><b><i class="fa fa-magic"></i>&nbsp;<i class="fa fa-book"></i> U. M.</b></h5>
            </button>
            <button class="w3-bar-item w3-button tablink" onclick="openTab(event, 'qr_help_id')">
              <h5><b><i class="fa fa-magic"></i>&nbsp;<i class="fa fa-book"></i> Q. R.</b></h5>
            </button>
        </div>
    ...
    <!-- User Management Help Tab -->
        <div id="um_help_id" 
            class="w3-container tab-content active-tab">
              <p>User Management</p>
        </div>

    <!-- Queue Rules Help Tab -->
        <div id="qr_help_id" 
            class="w3-container tab-content active-tab">
              <p>Queue Rules</p>
        </div>
