...
<div class="w3-container" style="margin-top: 32px">
        ...
        <div class="w3-bar w3-light-grey">
            <button class="w3-bar-item w3-button tablink" onclick="openTab(event, 'create_user_id')" id="defaultTab"><h5><b><i class="fa fa-user-plus"></i> Create User</b></h5></button>
            <button class="w3-bar-item w3-button tablink" onclick="openTab(event, 'user_list_id')"><h5><b><i class="fa fa-user-circle-o"></i> User List</b></h5></button>
        </div>
                ...
                <tbody>
                    ...
                    foreach ($all_users as $column) {
                        echo "<tr>
                                ...
                                <td> <button onclick='editClick(\"" . htmlspecialchars($column[0]) . "\")'>Edit</button> <button>Delete</button> </td>
                            </tr>";
                    }
                    ?>
                </tbody>
    ...
    $(document).ready(function() {
        ...
        function editClick(event) {
            // event.preventDefault();               
                ...
                $.ajax({
                    url: 'fetch-users.php', // The PHP script that handles the request
                    type: 'POST',
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            console.log(response.data.uname_fld);   
                            console.log(response.data.fname_fld);   
                            console.log(response.data.lname_fld);   
