    ...
    <h5><b><i class="fa fa-magic"></i> Club Event Management</b></h5>
        ...
        // }
            ...
            $sql_queue_rules = "SELECT a.queue_id_fld as queue_id_fld, 
                                        ...
                                        d.department_id_fld as department_id_fld,
                                        d.department_name_fld as department_name_fld, 
                                        e.program_id_fld as program_id_fld,
            ...
            while ($row = $result_queue_rules->fetch_assoc()) {
                ...
                if($row['queue_no_fld'] == 1){
                    ...
                    //Fist Noted by
                    //Department Name of CS - SAO

                    $queue_query = "AND a.first_noted_by_fld is NULL
                                    AND a.second_noted_by_fld is NULL   
                                    AND a.evaluated_by_fld is NULL 
                                    AND a.approved_by_fld is NULL";
                    break;
                }elseif($row['queue_no_fld'] == 2){
                    // $data[] = $row['queue_no_fld'];
                    $queue_number = $row['queue_no_fld'];
                    //Second Noted by
                    //Department Name of CS - Assistant Principal or Program Heads
                    $department_id_cs = $row['department_id_fld'];
                    
                    
                    // $program_id[] = explode(",",  $program_id_fld);
                    ...
                    //     $program_id_query .= "AND b.program_id_fld =" . $program;
                    //   }

                    $queue_query = "AND a.first_noted_by_fld is not NULL
                                    AND a.second_noted_by_fld is NULL   
                                    AND a.evaluated_by_fld is NULL 
                                    AND a.approved_by_fld is NULL
                                    AND b.department_id_fld = ". $department_id_cs .";";                    
                                    // AND a.department_id_fld = ". $department_id_cs . " " . $program_id_query .";";                    
                    break;
                }elseif($row['queue_no_fld'] == 3){
                    // $data[] = $row['queue_no_fld'];
                    $queue_number = $row['queue_no_fld'];
                    //Evaluated by
                    //Department Name of CS - Academic Head
                    ...
                    $queue_number = $row['queue_no_fld'];
                    //Approved by
                    //Department Name of CS - School Administrator
            ...
            // var_dump($program_id_fld);

            // echo json_encode($program_id_fld);
            ...
            $sql_club_event_proposal = "SELECT a.club_event_name_fld AS club_event_name_fld, 
                                                a.target_date_fld AS target_date_fld, 
                                                a.status_fld AS status_fld,
                                                a.date_submitted_fld AS date_submitted_fld,
                                                b.department_id_fld AS department_id_fld   
                                        FROM club_event_proposal_tbl AS a
                                        LEFT 
                                        JOIN user_tbl AS b
                                            ON a.submitted_by_fld = b.uname_fld
                                        WHERE a.status_fld = 'Pending'  ". $queue_query .";";

            // var_dump($sql_club_event_proposal); 
            ...
            $result_club_event_proposal->close();
            $mysqli->close();
        ?>
