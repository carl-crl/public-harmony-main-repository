...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2024 at 02:53 AM
...
--
--  `role_fld` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `user_tbl`
  MODIFY `uname_id_fld` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
