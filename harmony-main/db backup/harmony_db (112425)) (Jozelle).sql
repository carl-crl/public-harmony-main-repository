...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2024 at 02:17 AM
...
(2, 'Seniors\' Night 2024', '2025-01-14', 'Grade 12 Students', 'STI College Meycauayan', '- Mga tao talaga kapag naiinlab, nagiging corny\r\n- Edi wow', '10k kada pamilyang pilipino', 'Pending', 'christmaspasko', '2024-11-23 14:01:29', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'All I want for Christmas is yung 5k mo Ninong', '2024-11-23', 'Grade 12 Students', 'Sa Puso Mo', '- MAG SLOW MOTION KA STEPHEN PLS PLS PLSS\r\n- Mga tao talaga kapag naiinlab, nagiging corny', '10k kada pamilyang pilipino', 'Pending', 'christmaspasko', '2024-11-23 14:06:19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Poster Making Contest', '2024-11-23', 'Grade 12 Students', 'Trinitas College', '- Magdrawing', '1 Million Pesos', 'Pending', 'christmaspasko', '2024-11-23 14:21:33', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(2, 'watchasay', 'Jason', 'Derulo', NULL, 'Administrator', 'derulo@gmail.com', 0, '$2y$10$6NpxB6FqwjBrxY2rWkpPK.6IZiiYa8g5J0lYLp8r2tIjrPX5u/nT.'),
...
(24, 'micoabsent', 'Mico', 'Verano', NULL, 'Club Advisor', 'micoabsent@gmail.com', 0, '$2y$10$S4Dvd.zcP11WFSSFkDzZAumPVL8KeUPH14w5IpOJ17nnqQR0.s.cC');
...
--
ALTER TABLE `user_tbl`
  MODIFY `uname_id_fld` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
