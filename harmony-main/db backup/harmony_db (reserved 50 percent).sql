...
(3, 'College and Senior High School'),
(4, 'Admin');
...
CREATE TABLE `user_tbl` (
  ...
  `department_id_fld` int(255) NOT NULL,
  `program_id_fld` varchar(255) NOT NULL,
...
INSERT INTO `user_tbl` (`uname_id_fld`, `uname_fld`, `fname_fld`, `lname_fld`, `department_id_fld`, `program_id_fld`, `role_fld`, `email_fld`, `is_active`, `password_hash_fld`) VALUES
(1, 'admin2', 'Jozelle', 'Rafols', 4, '0', 'Administrator', 'admin2@gmail.com', 0, '$2y$10$1v5k8wXuuQP.QHuHBdeKd.gQS5V1PXrKNZH0cDZ7NpC2OUrqHedyu'),
(2, 'admin1', 'Carl', 'Pioquinto', 4, '0', 'Administrator', 'admin1@gmail.com', 0, '$2y$10$hUX2vZQFLOwGs45f3qimwuz2.doUHK5lbAQOuk4OW9Qg/gj1MSfZe'),
(3, 'schooladminuser', 'SchoolAdmin', 'College&SHS', 3, '10', 'Campus Supervisor', 'schooladminuser@example.com', 0, '$2y$10$PGmB.UGXq6gPiO8y/T6NuO2QamR820jDQ0E73Pdp4vUQUr04E.erq'),
(4, 'christmaspasko', 'Mariah', 'Carey', 1, '4', 'Club Advisor', 'christmas@gmail.com', 0, '$2y$10$n8PImjIVSrtf653gJ.c79uZMvl1yPLYY8Rg1SPrihZWpUHQh9gGZG'),
(11, 'acadheaduser', 'AcadHead', 'College&SHS', 3, '9', 'Campus Supervisor', 'acadheaduser@gmail.com', 0, '$2y$10$QzDRW68vesL6hF2ijlObS.bxWp/nodxXGgzhXY/kFc1yZPbpxidVq'),
(12, 'assistprinshs', 'AssistPrin', 'SHSUser', 2, '8', 'Campus Supervisor', 'assistprinshs@gmail.com', 0, '$2y$10$2ONwgIRcneDXtmjijYxsWOqv2qz0u9dJ8gURG00yQcWNc/ciuwYJe'),
(13, 'cstest1', 'CS', 'Tester', 3, '0', 'Campus Supervisor', 'cstest1@gmail.com', 0, '$2y$10$.diqVKxpZOJlkZuoInua5.j6M5dAjdTitlwpg7.XLvGNhrt5VC2fa'),
(14, 'saouser', 'SAO', 'College&SHS', 3, '7', 'Campus Supervisor', 'saouser@gmail.com', 0, '$2y$10$6v2kTJehUmd2cFTsXaa.Kuq8nJ6qs6FgpnvqcBRBPoU3QFD0bVy7q'),
(15, 'progheaditcpe', 'ProgramHead', 'IT&CPE', 1, '1, 2', 'Campus Supervisor', 'progheaditcpe@gmail.com', 0, '$2y$10$za4akwDVJutPVOZ4k2CNe.timM65XZE7S1pJpBMyJYYyDURnPAxP2'),
(16, 'progheadtmhmba', 'ProgramHead', 'TM&HM&BA', 1, '3, 4, 5', 'Campus Supervisor', 'progheadtmhmba@gmail.com', 0, '$2y$10$2NnxKiC1gPr1x215ln2yWu/V1x3r4tcGdgLaiXlOhRLVb1yPokBMm'),
(17, 'genedcollegeuser', 'GenEd', 'CollegeUser', 1, '6', 'Campus Supervisor', 'genedcollegeuser@gmail.com', 0, '$2y$10$vcqIb2590.SPgiQNwUfzdewYWCEHeES70vcCGscK4s39qKQo1M6rq'),
(18, 'ca_collegeit', 'P.', 'W.', 1, '0', 'Club Advisor', 'ca_collegeit@gmail.com', 0, '$2y$10$RZLzzA/lxCHHao7NLwUx2OPiAhnKSUSwKnBl1775YnQQMKR.5KnbO'),
(19, 'ca_collegecpe', 'M.', 'E.', 1, '0', 'Club Advisor', 'ca_collegecpe@gmail.com', 0, '$2y$10$5ydqTLR1nVW.4TJeR15bXOvu3hD8I7hFjBm3spfhWjl7tAHk3YAoG'),
(20, 'ca_collegetmhm', 'A.', 'J.', 1, '0', 'Club Advisor', 'ca_collegetmhm@gmail.com', 0, '$2y$10$PtjtIXb6/Rl9FcI9axRlQu3MWf.Z6xIzvjHXESoxdVHbC7hKqn84S'),
(21, 'athenacykes', 'A.', 'C.', 1, '0', 'Club Advisor', 'athenacykes@gmail.com', 0, '$2y$10$CbjnM0IwqhqYGsXP2wrptuzzwMclYxCsmlxgFKbrl.X89IyygAcNy'),
(22, 'admin3', 'Kurt', 'Llaguno', 4, '0', 'Administrator', 'admin3@gmail.com', 0, '$2y$10$eWKmjXOl5vRlPDji6Z5ME.Tli8..QEvvEEX4YYPywE/QAhhdkwzN6'),
(25, 'jsonderulo', 'Json', 'Derulo', 4, '0', 'Administrator', 'derulo@gmail.com', 0, '$2y$10$DXXxnTF88Rq90gcQ121KP.PlFLXGtULMuKWLVKU4U2mMlddqklw4i');
...
--
ALTER TABLE `queue_rules_tbl`
  MODIFY `queue_id_fld` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `user_tbl`
  MODIFY `uname_id_fld` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `user_tbl`
  ADD CONSTRAINT `department_fk` FOREIGN KEY (`department_id_fld`) REFERENCES `department_tbl` (`department_id_fld`);
COMMIT;
