...
--
-- Host: localhost:3306
-- Generation Time: Nov 26, 2024 at 09:10 PM
...
(1, 'Intramurals 2025', '2024-11-15', 'Grade 11 Students', 'Constantino Court', 'Intramurals 2025', '50,000.00', 'Pending', 'M. C.', '2024-11-23 07:22:33', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Seniors\' Night 2024', '2025-01-14', 'Grade 12 Students', 'STI College Meycauayan', '- Mga tao talaga kapag naiinlab, nagiging corny\r\n- Edi wow', '10k kada pamilyang pilipino', 'Pending', 'M. C.', '2024-11-23 14:01:29', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'All I want for Christmas is yung 5k mo Ninong', '2024-11-23', 'Grade 12 Students', 'Sa Puso Mo', '- MAG SLOW MOTION KA STEPHEN PLS PLS PLSS\r\n- Mga tao talaga kapag naiinlab, nagiging corny', '10k kada pamilyang pilipino', 'Pending', 'M. C.', '2024-11-23 14:06:19', '1', NULL, '1', NULL, NULL, NULL, NULL, NULL),
(4, 'Poster Making Contest', '2024-11-23', 'Grade 12 Students', 'Trinitas College', '- Magdrawing', '1 Million Pesos', 'Pending', 'M. C.', '2024-11-23 14:21:33', '1', NULL, '1', NULL, '1', NULL, NULL, NULL),
(5, 'Aesir Manhunt', '2025-04-24', 'Max Payne', 'Payne Residence', 'adasdasdasdafas', 'gagsdhdrhndfgh', 'Pending', 'M. C.', '2024-11-23 16:02:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'Test5 Event', '2025-02-28', 'Students', 'School', '- Objective 1\r\n- Objective 2\r\n- Objective 3\r\n- Objective 4\r\n- Objective 5', 'Greedisgood 999999999', 'Pending', 'M. C.', '2024-11-26 18:35:14', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `user_tbl` (`uname_id_fld`, `uname_fld`, `fname_fld`, `lname_fld`, `role_fld`, `email_fld`, `is_active`, `password_hash_fld`) VALUES
(1, 'admin2', 'Jozelle', 'Rafols', 'Administrator', 'admin2@gmail.com', 0, '$2y$10$1v5k8wXuuQP.QHuHBdeKd.gQS5V1PXrKNZH0cDZ7NpC2OUrqHedyu'),
(2, 'admin1', 'Carl', 'Pioquinto', 'Administrator', 'admin1@gmail.com', 0, '$2y$10$hUX2vZQFLOwGs45f3qimwuz2.doUHK5lbAQOuk4OW9Qg/gj1MSfZe'),
(3, 'schooladminuser', 'SchoolAdmin', 'College&SHS', 'Campus Supervisor', 'schooladminuser@example.com', 0, '$2y$10$PGmB.UGXq6gPiO8y/T6NuO2QamR820jDQ0E73Pdp4vUQUr04E.erq'),
(4, 'christmaspasko', 'M.', 'C.', 'Club Advisor', 'christmas@gmail.com', 0, '$2y$10$n8PImjIVSrtf653gJ.c79uZMvl1yPLYY8Rg1SPrihZWpUHQh9gGZG'),
(11, 'acadheaduser', 'AcadHead', 'College&SHS', 'Campus Supervisor', 'acadheaduser@gmail.com', 0, '$2y$10$QzDRW68vesL6hF2ijlObS.bxWp/nodxXGgzhXY/kFc1yZPbpxidVq'),
(12, 'assistprinshs', 'AssistPrin', 'SHSUser', 'Campus Supervisor', 'assistprinshs@gmail.com', 0, '$2y$10$2ONwgIRcneDXtmjijYxsWOqv2qz0u9dJ8gURG00yQcWNc/ciuwYJe'),
(13, 'cstest1', 'CS', 'Tester', 'Campus Supervisor', 'cstest1@gmail.com', 0, '$2y$10$.diqVKxpZOJlkZuoInua5.j6M5dAjdTitlwpg7.XLvGNhrt5VC2fa'),
(14, 'saouser', 'SAO', 'College&SHS', 'Campus Supervisor', 'saouser@gmail.com', 0, '$2y$10$6v2kTJehUmd2cFTsXaa.Kuq8nJ6qs6FgpnvqcBRBPoU3QFD0bVy7q'),
(15, 'progheaditcpe', 'ProgramHead', 'IT&CPE', 'Campus Supervisor', 'progheaditcpe@gmail.com', 0, '$2y$10$za4akwDVJutPVOZ4k2CNe.timM65XZE7S1pJpBMyJYYyDURnPAxP2'),
(16, 'progheadtmhmba', 'ProgramHead', 'TM&HM&BA', 'Campus Supervisor', 'progheadtmhmba@gmail.com', 0, '$2y$10$2NnxKiC1gPr1x215ln2yWu/V1x3r4tcGdgLaiXlOhRLVb1yPokBMm'),
(17, 'genedcollegeuser', 'GenEd', 'CollegeUser', 'Campus Supervisor', 'genedcollegeuser@gmail.com', 0, '$2y$10$vcqIb2590.SPgiQNwUfzdewYWCEHeES70vcCGscK4s39qKQo1M6rq'),
(18, 'ca_collegeit', 'P.', 'W.', 'Club Advisor', 'ca_collegeit@gmail.com', 0, '$2y$10$RZLzzA/lxCHHao7NLwUx2OPiAhnKSUSwKnBl1775YnQQMKR.5KnbO'),
(19, 'ca_collegecpe', 'M.', 'E.', 'Club Advisor', 'ca_collegecpe@gmail.com', 0, '$2y$10$5ydqTLR1nVW.4TJeR15bXOvu3hD8I7hFjBm3spfhWjl7tAHk3YAoG'),
(20, 'ca_collegetmhm', 'A.', 'J.', 'Club Advisor', 'ca_collegetmhm@gmail.com', 0, '$2y$10$PtjtIXb6/Rl9FcI9axRlQu3MWf.Z6xIzvjHXESoxdVHbC7hKqn84S'),
(21, 'athenacykes', 'A.', 'C.', 'Club Advisor', 'athenacykes@gmail.com', 0, '$2y$10$CbjnM0IwqhqYGsXP2wrptuzzwMclYxCsmlxgFKbrl.X89IyygAcNy'),
(22, 'admin3', 'Kurt', 'Llaguno', 'Administrator', 'admin3@gmail.com', 0, '$2y$10$eWKmjXOl5vRlPDji6Z5ME.Tli8..QEvvEEX4YYPywE/QAhhdkwzN6'),
(25, 'jsonderulo', 'Json', 'Derulo', 'Administrator', 'derulo@gmail.com', 0, '$2y$10$LT6DWhYHoCnE71YXQBHQPuuKLAnRRuUqo/wXGlhNaPH/J0uTabTvG');
...
--
ALTER TABLE `club_event_proposal_tbl`
  MODIFY `cep_id_fld` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `department_tbl`
--
ALTER TABLE `department_tbl`
  MODIFY `department_id_fld` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `queue_rules_tbl`
  MODIFY `queue_id_fld` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `user_tbl`
  MODIFY `uname_id_fld` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
